...
function own_style () {
    ...
    wp_enqueue_style('Gloria Hallelujah', 'https://fonts.googleapis.com/css?family=Gloria+Hallelujah&display=swap');
    wp_enqueue_style('style',  THEME_URL . '/dist/app.css', array('Montserrat', 'Gloria Hallelujah'));
}